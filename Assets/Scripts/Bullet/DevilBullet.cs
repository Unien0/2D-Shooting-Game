...
public class DevilBullet : NetworkBehaviour
{
    ...
    void Existence()
    {
        ...
        if (newTime >= linerBulletExistenceTime + devilData.devilbulletFillingTime)
        {
            newTime = 0f;
            DestoryBullet();
    ...
    void DealDamage(GameObject enemy)
    {
        ...
        int damage = (int)(playerBulletCurrentDamage * linerBulletCurrentDamageMultipler)+devilData.devilDamage;
        Debug.Log(damage);
